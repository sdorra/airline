		...
		this.each(function(){
			...
			function createNestedDOMStructure( menus, $wrapper ){
				...
				$.each( menus, function(){
					...
					var $title = $( "<h2 />" )
					    ...
					    $titleIcon = $( "<i />" )
					    .prop( { "class" : ( ( instance.settings.direction == 'ltr' ) ? "floatLeft" : "floatRight" ) + " cursorPointer " + this.icon } )
					    .prependTo( $title );
			...
			function updateNestedDOMStructure( $wrapper ){
				...
				$.each( $wrapper, function(){
					...
					$titleIcon.addClass( ( ( instance.settings.direction == 'ltr' ) ? "floatLeft" : "floatRight" ) + " cursorPointer" );
					$titleIcon.bind( clickEventType , function(e){
					...
					$.each($itemGroup.children( 'li' ), function(){
						...
						$itemIcon.addClass( ( ( instance.settings.direction == 'ltr' ) ? "floatLeft" : "floatRight" ) );
			...
			function createBackItem( $levelHolder ) {
				var $backItem = $( "<div />" )
				    ...
				    .appendTo( $backItem ),
				    $backItemIcon = $( "<i />" )
				    .prop( { "class" : ( ( instance.settings.direction == 'ltr' ) ? "floatLeft " : "floatRight " ) + instance.settings.backItemIcon } )
